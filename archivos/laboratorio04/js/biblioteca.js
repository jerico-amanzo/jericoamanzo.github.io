...
//creamos  una funcion  para  validar  nombre //  function  ValidarNombre(){
//	if(txtNom.value==""	11 txtNom.value==null){
//	error.style.display='block';
...
//	if(txtApe.value==""   II  txtApe.value==null){
//	error.style.display='block';
...
//	if(txtCor.value==""   II  txtCor.value==null){
//	error.style.display='block';
...
//	if(sexo.value==""  II  sexo.value==null){
//	error.style.display='block';
...
function Validar(){
    ...
    txtApe.focus();
        ...
        LlamarClase("Por favor  seleccione  su  sexo");
        LlamarClase("Por favor  seleccione  su estado"); rbMas.focus();
    }else  if(chkEst.checked==false){
    LlamarClase("Por favor  seleccione  su estado"); chkEst.focus();
    }else{
    error.style.display='none'; 
    }
